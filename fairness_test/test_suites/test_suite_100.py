...
function_namespace = "eligible_for_community_scholarship"
...
class TestFairness:
    ...
    def setup_class(self):
        setup_test_environment(FILE_PATH, CommunityScholarshipApplicant, function_namespace)

    @pytest.mark.parametrize("attribute", SENSITIVE_ATTRIBUTES)
    def test_attribute_fairness(self, attribute):
        single_attribute_fairness_test(attribute, DEMOGRAPHIC_DATA, CommunityScholarshipApplicant, FILE_PATH, report_dir,
