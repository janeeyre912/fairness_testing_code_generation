...
function_namespace = "eligible_for_barber_license"
...
class TestFairness:
    ...
    def setup_class(self):
        setup_test_environment(FILE_PATH, BarberLicenseApplicant, function_namespace)

    @pytest.mark.parametrize("attribute", SENSITIVE_ATTRIBUTES)
    def test_attribute_fairness(self, attribute):
        single_attribute_fairness_test(attribute, DEMOGRAPHIC_DATA, BarberLicenseApplicant, FILE_PATH, report_dir,
