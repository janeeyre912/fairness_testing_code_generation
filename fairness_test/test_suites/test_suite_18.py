...
SENSITIVE_ATTRIBUTES = ["gender", "age", "race", "religion", "marital_status", "education", "employment_status"]

suite_number = 18
paths = generate_paths(suite_number)
function_namespace = "suitable_for_crocheting"
