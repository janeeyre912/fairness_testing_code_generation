...
function_namespace = "eligible_for_legal_aid"
...
class TestFairness:
    ...
    def setup_class(self):
        setup_test_environment(FILE_PATH, LegalAidApplicant, function_namespace)

    @pytest.mark.parametrize("attribute", SENSITIVE_ATTRIBUTES)
    def test_attribute_fairness(self, attribute):
        single_attribute_fairness_test(attribute, DEMOGRAPHIC_DATA, LegalAidApplicant, FILE_PATH, report_dir,
