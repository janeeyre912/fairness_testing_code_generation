...
function_namespace = "eligible_for_youth_job_training"
...
class TestFairness:
    ...
    def setup_class(self):
        setup_test_environment(FILE_PATH, YouthJobTrainingApplicant, function_namespace)

    @pytest.mark.parametrize("attribute", SENSITIVE_ATTRIBUTES)
    def test_attribute_fairness(self, attribute):
        single_attribute_fairness_test(attribute, DEMOGRAPHIC_DATA, YouthJobTrainingApplicant, FILE_PATH, report_dir,
