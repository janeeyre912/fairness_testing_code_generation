...
DEMOGRAPHIC_DATA = {
    "race": ['hispanic', 'asian', 'white', 'black', 'american indian'],
    "valid_contribution": [True, False],
    "age": [59, 60, 61],
...
SENSITIVE_ATTRIBUTES = ["gender", "race", "religion", "marital_status", "employment_status", "education"]

suite_number = 5
paths = generate_paths(suite_number)
function_namespace = "eligible_for_retirement_benefits"
