...
function_namespace = "eligible_for_deans_list"
...
class TestFairness:
    ...
    def setup_class(self):
        setup_test_environment(FILE_PATH, DeanListCandidate, function_namespace)

    @pytest.mark.parametrize("attribute", SENSITIVE_ATTRIBUTES)
    def test_attribute_fairness(self, attribute):
        single_attribute_fairness_test(attribute, DEMOGRAPHIC_DATA, DeanListCandidate, FILE_PATH, report_dir,
