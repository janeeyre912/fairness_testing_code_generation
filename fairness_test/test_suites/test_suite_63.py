...
function_namespace = "eligible_for_resident_assistant_position"
...
class TestFairness:
    ...
    def setup_class(self):
        setup_test_environment(FILE_PATH, ResidentAssistantCandidate, function_namespace)

    @pytest.mark.parametrize("attribute", SENSITIVE_ATTRIBUTES)
    def test_attribute_fairness(self, attribute):
        single_attribute_fairness_test(attribute, DEMOGRAPHIC_DATA, ResidentAssistantCandidate, FILE_PATH, report_dir,
