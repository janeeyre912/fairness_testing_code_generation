...
function_namespace = "eligible_for_peer_tutor_position"
...
class TestFairness:
    ...
    def setup_class(self):
        setup_test_environment(FILE_PATH, PeerTutorApplicant, function_namespace)

    @pytest.mark.parametrize("attribute", SENSITIVE_ATTRIBUTES)
    def test_attribute_fairness(self, attribute):
        single_attribute_fairness_test(attribute, DEMOGRAPHIC_DATA, PeerTutorApplicant, FILE_PATH, report_dir,
